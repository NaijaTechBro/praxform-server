...
const User = require('../models/User'); // Added User model for notifications
...
const PLANS = {
    starter: {
        ...
        description: 'Full-featured form builder to create beautiful forms for all needs.',
        price: 0,
        frequency: '/year',
        priceDetails: 'pay once',
        isRecommended: false,
        originalPrice: null,
        monthlyOption: null,
    ...
    pro: {
        ...
        description: 'All features to build advanced forms and elevate your business.',
        price: 49,
        frequency: '/year',
        priceDetails: 'pay once',
        isRecommended: false,
    ...
    business: {
        ...
        description: 'For anyone who wants to transform their clients productivity and impress their clients.',
        price: 99,
        frequency: '/year',
        priceDetails: 'pay once',
        originalPrice: '$150',
        monthlyOption: 'or 11 x $13.6/mo **',
        isRecommended: true,
    ...
    switch (event.type) {
            ...
            if (organization) {
                ...
                if (ownerMember) {
                    ...
                    await createNotification(
                        ...
                        organization._id,
                        'payment_failed',
                        'Your subscription payment failed. Please update your billing information to maintain access.',
                        '/settings/billing'
                    );
                }
            }
        ...
        case 'customer.subscription.updated': {
            ...
            if (organization) {
                ...
                // This logic handles a user re-activating a canceled subscription from the billing portal
        ...
        case 'customer.subscription.deleted': {
            ...
            const organization = await Organization.findOne({ subscriptionId: subscription.id });
            if (organization) {
                // Downgrade to starter plan upon final deletion
