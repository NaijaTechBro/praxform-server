...
//         const emailVerificationTokenHashed = crypto.createHash('sha256').update(verificationToken).digest('hex');
//         const emailVerificationTokenExpires = Date.now() + 3600000; // Token valid for 1 hour
...
//             role: userRole,
//             authMethod: 'local',
//             isEmailVerified: false, // User is not verified until they click the link
...
//         // Construct the verification URL using environment variables for robustness
//         const verificationUrl = `${req.protocol}://${process.env.PRAXFORM_HOST}/api/v1/auth/verifyemail/${verificationToken}`;
...
//     // Send verification email
//     const verifyUrl = `${req.protocol}://${process.env.PRAXFORM_HOST}/api/v1/auth/verifyemail/${verificationToken}`;
...
//     // Send reset email
//     const resetUrl = `${req.protocol}://${process.env.PRAXFORM_HOST}/api/v1/auth/resetpassword/${resetToken}`;
...
//     user.passwordHash = req.body.password; // password will be hashed by pre-save hook
//     user.resetPasswordToken = undefined;
//     user.resetPasswordExpires = undefined;
